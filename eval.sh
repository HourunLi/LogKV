...
emit("LOG_KV_SEG_G0", value_or("log_kv_seg_g0", 2048.0))
emit("LOG_KV_SEG_GAP_MAX", cfg.get("log_kv_seg_gap_max"))
emit("LOG_KV_SEG_BLOCK_LEVEL", value_or("log_kv_seg_block_level", 0))
emit("LOG_KV_SEG_FORGET", value_or("log_kv_seg_forget", 0.5))
emit("LOG_KV_SEMANTIC_S_H_PATH", cfg.get("log_kv_semantic_s_h_path"))
emit("LOG_KV_SEMANTIC_FLUSH_GRANULARITY", value_or("log_kv_semantic_flush_granularity", 2))
